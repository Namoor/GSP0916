...
void Shader::LoadShader( wchar_t* p_ShaderFile, char* p_VertexFunctionName, char* p_PixelFunctionName, ID3D11Device* p_pDevice, ID3D11DeviceContext* p_pDevCon )
{
	m_pDevice = p_pDevice;
	m_pDevCon = p_pDevCon;
...
void Shader::AddInputLayoutEntry( char* p_SemanticName, int p_SemanticIndex, int p_ByteOffset, DXGI_FORMAT p_Format )
{
...
void Shader::FinalizeInputLayout( )
{
